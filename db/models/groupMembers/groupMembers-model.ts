...
async function createGroupMember(data: CreateGroupMember): Promise<GroupMembers> {
    try {
...
async function getGroupMember(data: GetGroupMember): Promise<GroupMembers> {
    try {
...
async function getGroupMembers(data: GetGroupMembers) {
    try {
...
async function updateGroupIsAdmin(data: UpdateGroupIsAdmin) {
    try {
...
async function deleteGroupMember(data: DeleteGroupMember) {
    try {
