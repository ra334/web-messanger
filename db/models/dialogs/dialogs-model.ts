...
async function createDialog(data: CreateDialog): Promise<Dialog> {
    try {
...
async function getDialog(data: GetDialog): Promise<Dialog> {
    try {
...
async function getDialogs(data: GetDialogs): Promise<Dialog[]> {
    try {
...
async function updateIsDeletedForSender(data: UpdateIsDeletedForSender): Promise<Dialog> {
    try {
...
async function updateIsDeletedForReceiver(data: UpdateIsDeletedForReceiver): Promise<Dialog> {
    try {
        const dialog = await db
            .update(dialogs)
            .set({
...
async function updateLastMessage(data: UpdateLastMessage): Promise<Dialog> {
    try {
        const dialog = await db
            .update(dialogs)
            .set({
...
async function deleteDialog(data: DeleteDialog): Promise<Dialog> {
    try {
        const dialog = await db
            .delete(dialogs)
            .where(eq(dialogs.id, data.id))
